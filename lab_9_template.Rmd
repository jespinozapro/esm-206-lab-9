...
# Note: this is bad because pricepersqrfoot is calculated from the dependent variable price - biased overfitting 

# Price = -62690 - 76863(SLO) - 9068.2(ATASC) + 120160(SM ORCUTT) + 230.7(SqFt)
...
# overall, heteroscedasticity is ok, residuals normality definitely looks good, and conceptually and mathematcally my model is making sense.
...
# using AIC lower the number = stonger model
# still pick homes_lm3 regardless of higher AIC.
```
